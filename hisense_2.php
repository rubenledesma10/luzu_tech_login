...
<head>
    ...
    <title>LuzuTech | SMART LED TV 50 PULGADAS 4K UHD 9150A641GSV HISENSE </title>
...
<body>
    ...
    $televisores = array (
        ...
        'marca'=>'HISENSE ',
        'descripcion'=>'Televisor Smart. Pantalla 50" 4K. Resolucion: 3840 x 2160 Px. Potencia RMs: 8 W x 4. USB x2. HDMI x3. Bluetooth. Brillo: 250 Cd/m2. Radio de contraste : 5000:1. WIFI. Tipo de sonido: Estereo (Standard / Teatro / Musica / Dialogo / Nocturno). Frecuencia de barrido: 60 Hz. Sintonizador TDA. Entrada PC.',
        'precio'=>'83000'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/hisense_2.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
