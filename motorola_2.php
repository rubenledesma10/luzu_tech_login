...
<head>
    ...
    <title>LuzuTech | SMART LED ANDROID TV 43 PULGADAS FULL HD MOTOROLA </title>
...
<body>
    ...
    <?php
    $televisores = array (
        'nombre'=>'SMART LED ANDROID TV 43 PULGADAS HD',
        'marca'=>'MOTOROLA ',
        'descripcion'=>'TV led smart de 43". Resolucion 1920X1080. Cuenta con dos puertos USB y dos puertos HDMI. Sintonizador TDA. Frecuencia de barrido 50HZ/60HZ. Potencia de parlantes 8w RMS (x2). WiFi. Bluetooth. Medidas con base 59,73X95,61X20,45 cm.',
        'precio'=>'87500'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/motorola_2.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
