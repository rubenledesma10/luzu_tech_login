...
<head>
    ...
    <title>LuzuTech | LAVARROPAS SEMIAUTOMATICO LTPK67SB 6 BLANCO PATRICK </title>
...
<body>
    ...
    $lavarropas = array (
        ...
        'marca'=>'PATRICK ',
        'descripcion'=>'Lavarropas Semiautomatico. Capacidad: 6 Kg. 7 Programas: Eco - Enjuague - Sintetico - Algodon - Color -Sucio - Muy sucio. Dispenser de detergente y suavizante. Motor termoprotegido. Interriuptor de seguridad. Tambor de acero inoxidable. Comando superior: Con selector de perilla. Sistema de lavado europeo. Tapa Transparente: Mayor visibilidad. Facil apertura y cierre de tambor.',
        'precio'=>'125000'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/patrick_2.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
