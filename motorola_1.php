...
<head>
    ...
    <title>LuzuTech | SMART LED ANDROID TV 32 PULGADAS HD MOTOROLA </title>
...
<body>
    ...
    $televisores = array (
        ...
        'marca'=>'MOTOROLA ',
        'descripcion'=>'TV led smart de 32" .Resolucion 1366x768. Cuenta con dos puertos USB y dos puertos HDMI. Sintonizador TDA. Frecuencia de barrido 50HZ/60HZ. Potencia de parlantes 8w RMS (x2). WiFi . Bluetooth. Medidas con base 45,6x72,07x16,54 cm.',
        'precio'=>'58000'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/motorola_1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
