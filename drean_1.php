...
<head>
    ...
    <title>LuzuTech | LAVARROPAS AUTOMATICO NEXT 6.06 ECO 6 BLANCO DREAN </title>
...
<body>
    ...
    $lavarropas = array (
        ...
        'marca'=>'DREAN ',
        'descripcion'=>'Clase AA. Cap.6 Kg. Display Led. Carga Autoadaptativa. Sist.Autobalance. 29 Alternativas de lavado. Puerta extra grande. Ciclos especificos de lavado. Antiarrugas. Lavado rapido. Lavado de 1/2 hr. Eco Wash. Hand Wash. Control de temperatura. 600RPM.',
        'precio'=>'126000'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/drean_1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
