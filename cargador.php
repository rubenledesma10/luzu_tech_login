...
<head>
    ...
    <title>LuzuTech | CARGADOR PORTATIL IPH050B TAGWOOD </title>
...
<body>
    ...
    $varios = array (
        ...
        'marca'=>'TAGWOOD ',
        'descripcion'=>'Cargador portatil con bateria de Litio para Smartphones y Tablets. Capacidad: 2600mAh. Salida: 5V - 1000mAh. Tiempo de carga: 2hs. Incluye cable USB a Micro USB. LED titilante indicadora del nivel de bateria.',
        'precio'=>'2900'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/cargador.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
