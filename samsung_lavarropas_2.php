...
<head>
    ...
    <title>LuzuTech |LAVARROPAS AUTOMATICO WA80F5S4UDW 8 SAMSUNG </title>
...
<body>
    ...
    $lavarropas = array (
        ...
        'marca'=>'SAMSUNG ',
        'descripcion'=>'Panel de control y display digital. Capacidad 8Kg. 700RPM. 9 Programas de lavado. Tambor de acero inoxidable diseno diamante. Pulsador Wobble (previene enredos y danos en la ropa). Final diferido. Seguro p/ninos. Eficiencia Energetica A.',
        'precio'=>'169000'
    );
    ?>
    <div class="container">
        <div class=" mx-auto card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="imagenes/lavarropas_samsung_2.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
